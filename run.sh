...
RESIZE_SCALE=0.5
NUM_IMAGE=10000
training_output_folder="training_output_${MODEL}_bs${BS}_e${NUM_EPOCHS}_resize${RESIZE_SCALE}_num_img${NUM_IMAGE}"
mkdir ${training_output_folder}
eval_output_folder="eval_output_${MODEL}_bs${BS}_e${NUM_EPOCHS}_resize${RESIZE_SCALE}_num_img${NUM_IMAGE}"
...
do
   ...
   do
      ...
      # TRAIN_FILE_NAME="${training_output_folder}/training_${MODEL}_is${IMAGE_SIZE}_bs${BS}_e${NUM_EPOCHS}_${IMAGE_PATH}.txt"
      ...
      do
         EVAL_FILE_NAME="${eval_output_folder}/eval_${MODEL}_is${IMAGE_SIZE}_bs${BS}_e${NUM_EPOCHS}_i${NUM_IMAGE}_${IMAGE_PATH}.txt"
