...
do
   ...
   do
      ...
      do
         EVAL_FILE_NAME="${output_folder}/eval_${MODEL}_bs${BS}_e${NUM_EPOCHS}_trainIs${train_image_size}_trainContrastReduce${train_contrast_reduce}_testIs${test_image_size}_i${NUM_IMAGE}_test${IMAGE_PATH}.txt"
